...
export class KaggleIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#20BEFF';
...
export function registerKaggleIcon(name = 'devicon-kaggle') {
  if (!customElements.get(name)) {
    customElements.define(name, KaggleIconElement);
  }
}
