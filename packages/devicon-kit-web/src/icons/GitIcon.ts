...
export class GitIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F05032';
...
export function registerGitIcon(name = 'devicon-git') {
  if (!customElements.get(name)) {
    customElements.define(name, GitIconElement);
  }
}
