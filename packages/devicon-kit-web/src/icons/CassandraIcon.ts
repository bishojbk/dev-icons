...
export class CassandraIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1287B1';
...
export function registerCassandraIcon(name = 'devicon-cassandra') {
  if (!customElements.get(name)) {
    customElements.define(name, CassandraIconElement);
  }
}
