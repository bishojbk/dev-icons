...
export class BlenderIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E87D0D';
...
export function registerBlenderIcon(name = 'devicon-blender') {
  if (!customElements.get(name)) {
    customElements.define(name, BlenderIconElement);
  }
}
