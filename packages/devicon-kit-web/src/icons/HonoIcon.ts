...
export class HonoIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E36002';
...
export function registerHonoIcon(name = 'devicon-hono') {
  if (!customElements.get(name)) {
    customElements.define(name, HonoIconElement);
  }
}
