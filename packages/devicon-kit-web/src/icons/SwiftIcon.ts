...
export class SwiftIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F05138';
...
export function registerSwiftIcon(name = 'devicon-swift') {
  if (!customElements.get(name)) {
    customElements.define(name, SwiftIconElement);
  }
}
