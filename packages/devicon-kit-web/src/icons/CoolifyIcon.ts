...
export class CoolifyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#6B16ED';
...
export function registerCoolifyIcon(name = 'devicon-coolify') {
  if (!customElements.get(name)) {
    customElements.define(name, CoolifyIconElement);
  }
}
