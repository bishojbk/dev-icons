...
export class BabelIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F9DC3E';
...
export function registerBabelIcon(name = 'devicon-babel') {
  if (!customElements.get(name)) {
    customElements.define(name, BabelIconElement);
  }
}
