...
export class CentosIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#262577';
...
export function registerCentosIcon(name = 'devicon-centos') {
  if (!customElements.get(name)) {
    customElements.define(name, CentosIconElement);
  }
}
