...
export class MysqlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#4479A1';
...
export function registerMysqlIcon(name = 'devicon-mysql') {
  if (!customElements.get(name)) {
    customElements.define(name, MysqlIconElement);
  }
}
