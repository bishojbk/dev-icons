...
export class ChartdotjsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF6384';
...
export function registerChartdotjsIcon(name = 'devicon-chartdotjs') {
  if (!customElements.get(name)) {
    customElements.define(name, ChartdotjsIconElement);
  }
}
