...
export class SamsungIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1428A0';
...
export function registerSamsungIcon(name = 'devicon-samsung') {
  if (!customElements.get(name)) {
    customElements.define(name, SamsungIconElement);
  }
}
