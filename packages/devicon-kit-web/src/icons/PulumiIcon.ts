...
export class PulumiIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#8A3391';
...
export function registerPulumiIcon(name = 'devicon-pulumi') {
  if (!customElements.get(name)) {
    customElements.define(name, PulumiIconElement);
  }
}
