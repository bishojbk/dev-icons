...
export class NeovimIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#57A143';
...
export function registerNeovimIcon(name = 'devicon-neovim') {
  if (!customElements.get(name)) {
    customElements.define(name, NeovimIconElement);
  }
}
