...
export class SnapchatIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FFFC00';
...
export function registerSnapchatIcon(name = 'devicon-snapchat') {
  if (!customElements.get(name)) {
    customElements.define(name, SnapchatIconElement);
  }
}
