...
export class ApacheIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#D22128';
...
export function registerApacheIcon(name = 'devicon-apache') {
  if (!customElements.get(name)) {
    customElements.define(name, ApacheIconElement);
  }
}
