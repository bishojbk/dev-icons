...
export function registerSymfonyIcon(name = 'devicon-symfony') {
  if (!customElements.get(name)) {
    customElements.define(name, SymfonyIconElement);
  }
}
