...
export class DocusaurusIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#3ECC5F';
...
export function registerDocusaurusIcon(name = 'devicon-docusaurus') {
  if (!customElements.get(name)) {
    customElements.define(name, DocusaurusIconElement);
  }
}
