...
export class ManjaroIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#35BFA4';
...
export function registerManjaroIcon(name = 'devicon-manjaro') {
  if (!customElements.get(name)) {
    customElements.define(name, ManjaroIconElement);
  }
}
