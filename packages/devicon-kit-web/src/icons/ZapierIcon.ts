...
export class ZapierIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF4F00';
...
export function registerZapierIcon(name = 'devicon-zapier') {
  if (!customElements.get(name)) {
    customElements.define(name, ZapierIconElement);
  }
}
