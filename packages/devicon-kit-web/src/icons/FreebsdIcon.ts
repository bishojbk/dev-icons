...
export class FreebsdIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#AB2B28';
...
export function registerFreebsdIcon(name = 'devicon-freebsd') {
  if (!customElements.get(name)) {
    customElements.define(name, FreebsdIconElement);
  }
}
