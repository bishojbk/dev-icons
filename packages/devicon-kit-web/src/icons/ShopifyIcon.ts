...
export class ShopifyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#7AB55C';
...
export function registerShopifyIcon(name = 'devicon-shopify') {
  if (!customElements.get(name)) {
    customElements.define(name, ShopifyIconElement);
  }
}
