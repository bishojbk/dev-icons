...
export class JuliaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#9558B2';
...
export function registerJuliaIcon(name = 'devicon-julia') {
  if (!customElements.get(name)) {
    customElements.define(name, JuliaIconElement);
  }
}
