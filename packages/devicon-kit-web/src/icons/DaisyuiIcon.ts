...
export class DaisyuiIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FFC63A';
...
export function registerDaisyuiIcon(name = 'devicon-daisyui') {
  if (!customElements.get(name)) {
    customElements.define(name, DaisyuiIconElement);
  }
}
