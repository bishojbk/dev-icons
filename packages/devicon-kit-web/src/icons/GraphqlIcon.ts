...
export class GraphqlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E10098';
...
export function registerGraphqlIcon(name = 'devicon-graphql') {
  if (!customElements.get(name)) {
    customElements.define(name, GraphqlIconElement);
  }
}
