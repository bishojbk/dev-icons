...
export class GunicornIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#499848';
...
export function registerGunicornIcon(name = 'devicon-gunicorn') {
  if (!customElements.get(name)) {
    customElements.define(name, GunicornIconElement);
  }
}
