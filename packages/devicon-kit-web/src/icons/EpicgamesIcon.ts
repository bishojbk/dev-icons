...
export class EpicgamesIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#313131';
...
export function registerEpicgamesIcon(name = 'devicon-epicgames') {
  if (!customElements.get(name)) {
    customElements.define(name, EpicgamesIconElement);
  }
}
