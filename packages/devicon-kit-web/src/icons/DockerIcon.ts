...
export class DockerIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2496ED';
...
export function registerDockerIcon(name = 'devicon-docker') {
  if (!customElements.get(name)) {
    customElements.define(name, DockerIconElement);
  }
}
