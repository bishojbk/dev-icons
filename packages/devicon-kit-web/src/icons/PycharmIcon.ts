...
export class PycharmIconElement extends HTMLElement {
...
export function registerPycharmIcon(name = 'devicon-pycharm') {
  if (!customElements.get(name)) {
    customElements.define(name, PycharmIconElement);
  }
}
