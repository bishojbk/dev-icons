...
export class PaypalIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#002991';
...
export function registerPaypalIcon(name = 'devicon-paypal') {
  if (!customElements.get(name)) {
    customElements.define(name, PaypalIconElement);
  }
}
