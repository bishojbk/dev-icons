...
export function registerReadthedocsIcon(name = 'devicon-readthedocs') {
  if (!customElements.get(name)) {
    customElements.define(name, ReadthedocsIconElement);
  }
}
