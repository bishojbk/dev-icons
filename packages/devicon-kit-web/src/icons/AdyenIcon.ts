...
export class AdyenIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#0ABF53';
...
export function registerAdyenIcon(name = 'devicon-adyen') {
  if (!customElements.get(name)) {
    customElements.define(name, AdyenIconElement);
  }
}
