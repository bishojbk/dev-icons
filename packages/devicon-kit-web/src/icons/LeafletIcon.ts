...
export class LeafletIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#199900';
...
export function registerLeafletIcon(name = 'devicon-leaflet') {
  if (!customElements.get(name)) {
    customElements.define(name, LeafletIconElement);
  }
}
