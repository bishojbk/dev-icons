...
export class SnykIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#4C4A73';
...
export function registerSnykIcon(name = 'devicon-snyk') {
  if (!customElements.get(name)) {
    customElements.define(name, SnykIconElement);
  }
}
