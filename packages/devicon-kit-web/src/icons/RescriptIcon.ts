...
export class RescriptIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E6484F';
...
export function registerRescriptIcon(name = 'devicon-rescript') {
  if (!customElements.get(name)) {
    customElements.define(name, RescriptIconElement);
  }
}
