...
export class DigitaloceanIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#0080FF';
...
export function registerDigitaloceanIcon(name = 'devicon-digitalocean') {
  if (!customElements.get(name)) {
    customElements.define(name, DigitaloceanIconElement);
  }
}
