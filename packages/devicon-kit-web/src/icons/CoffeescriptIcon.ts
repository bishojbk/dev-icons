...
export class CoffeescriptIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2F2625';
...
export function registerCoffeescriptIcon(name = 'devicon-coffeescript') {
  if (!customElements.get(name)) {
    customElements.define(name, CoffeescriptIconElement);
  }
}
