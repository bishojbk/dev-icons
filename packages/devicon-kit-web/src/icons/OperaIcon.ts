...
export class OperaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF1B2D';
...
export function registerOperaIcon(name = 'devicon-opera') {
  if (!customElements.get(name)) {
    customElements.define(name, OperaIconElement);
  }
}
