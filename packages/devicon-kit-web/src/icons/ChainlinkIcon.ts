...
export class ChainlinkIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#375BD2';
...
export function registerChainlinkIcon(name = 'devicon-chainlink') {
  if (!customElements.get(name)) {
    customElements.define(name, ChainlinkIconElement);
  }
}
