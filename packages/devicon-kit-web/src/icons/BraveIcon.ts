...
export class BraveIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FB542B';
...
export function registerBraveIcon(name = 'devicon-brave') {
  if (!customElements.get(name)) {
    customElements.define(name, BraveIconElement);
  }
}
