...
export function registerDiscordIcon(name = 'devicon-discord') {
  if (!customElements.get(name)) {
    customElements.define(name, DiscordIconElement);
  }
}
