...
export class AsanaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F06A6A';
...
export function registerAsanaIcon(name = 'devicon-asana') {
  if (!customElements.get(name)) {
    customElements.define(name, AsanaIconElement);
  }
}
