...
export class AmdIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#ED1C24';
...
export function registerAmdIcon(name = 'devicon-amd') {
  if (!customElements.get(name)) {
    customElements.define(name, AmdIconElement);
  }
}
