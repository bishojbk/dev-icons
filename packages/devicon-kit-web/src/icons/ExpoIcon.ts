...
export class ExpoIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1C2024';
...
export function registerExpoIcon(name = 'devicon-expo') {
  if (!customElements.get(name)) {
    customElements.define(name, ExpoIconElement);
  }
}
