...
export class ReactqueryIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF4154';
...
export function registerReactqueryIcon(name = 'devicon-reactquery') {
  if (!customElements.get(name)) {
    customElements.define(name, ReactqueryIconElement);
  }
}
