...
export class ContentfulIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2478CC';
...
export function registerContentfulIcon(name = 'devicon-contentful') {
  if (!customElements.get(name)) {
    customElements.define(name, ContentfulIconElement);
  }
}
