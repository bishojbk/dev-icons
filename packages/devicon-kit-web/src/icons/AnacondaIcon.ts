...
export class AnacondaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#44A833';
...
export function registerAnacondaIcon(name = 'devicon-anaconda') {
  if (!customElements.get(name)) {
    customElements.define(name, AnacondaIconElement);
  }
}
