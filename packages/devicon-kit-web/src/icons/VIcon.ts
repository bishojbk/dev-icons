...
export class VIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5D87BF';
...
export function registerVIcon(name = 'devicon-v') {
  if (!customElements.get(name)) {
    customElements.define(name, VIconElement);
  }
}
