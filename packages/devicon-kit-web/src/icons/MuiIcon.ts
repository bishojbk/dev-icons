...
export class MuiIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#007FFF';
...
export function registerMuiIcon(name = 'devicon-mui') {
  if (!customElements.get(name)) {
    customElements.define(name, MuiIconElement);
  }
}
