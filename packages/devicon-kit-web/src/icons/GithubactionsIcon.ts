...
export class GithubactionsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2088FF';
...
export function registerGithubactionsIcon(name = 'devicon-githubactions') {
  if (!customElements.get(name)) {
    customElements.define(name, GithubactionsIconElement);
  }
}
