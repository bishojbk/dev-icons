...
export class GlitchIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#3333FF';
...
export function registerGlitchIcon(name = 'devicon-glitch') {
  if (!customElements.get(name)) {
    customElements.define(name, GlitchIconElement);
  }
}
