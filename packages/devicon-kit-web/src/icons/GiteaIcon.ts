...
export class GiteaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#609926';
...
export function registerGiteaIcon(name = 'devicon-gitea') {
  if (!customElements.get(name)) {
    customElements.define(name, GiteaIconElement);
  }
}
