...
export class XmlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#005FAD';
...
export function registerXmlIcon(name = 'devicon-xml') {
  if (!customElements.get(name)) {
    customElements.define(name, XmlIconElement);
  }
}
