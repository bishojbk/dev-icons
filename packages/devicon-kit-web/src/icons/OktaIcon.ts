...
export class OktaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#007DC1';
...
export function registerOktaIcon(name = 'devicon-okta') {
  if (!customElements.get(name)) {
    customElements.define(name, OktaIconElement);
  }
}
