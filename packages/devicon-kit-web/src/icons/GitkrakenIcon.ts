...
export class GitkrakenIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#179287';
...
export function registerGitkrakenIcon(name = 'devicon-gitkraken') {
  if (!customElements.get(name)) {
    customElements.define(name, GitkrakenIconElement);
  }
}
