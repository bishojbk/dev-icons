...
export class NodejsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5FA04E';
...
export function registerNodejsIcon(name = 'devicon-nodejs') {
  if (!customElements.get(name)) {
    customElements.define(name, NodejsIconElement);
  }
}
