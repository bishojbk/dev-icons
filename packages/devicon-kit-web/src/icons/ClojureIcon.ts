...
export class ClojureIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5881D8';
...
export function registerClojureIcon(name = 'devicon-clojure') {
  if (!customElements.get(name)) {
    customElements.define(name, ClojureIconElement);
  }
}
