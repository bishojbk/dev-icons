...
export class YarnIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2C8EBB';
...
export function registerYarnIcon(name = 'devicon-yarn') {
  if (!customElements.get(name)) {
    customElements.define(name, YarnIconElement);
  }
}
