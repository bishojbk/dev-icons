...
export class PlexIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#EBAF00';
...
export function registerPlexIcon(name = 'devicon-plex') {
  if (!customElements.get(name)) {
    customElements.define(name, PlexIconElement);
  }
}
