...
export class VivaldiIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#EF3939';
...
export function registerVivaldiIcon(name = 'devicon-vivaldi') {
  if (!customElements.get(name)) {
    customElements.define(name, VivaldiIconElement);
  }
}
