...
export class ElectronIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#47848F';
...
export function registerElectronIcon(name = 'devicon-electron') {
  if (!customElements.get(name)) {
    customElements.define(name, ElectronIconElement);
  }
}
