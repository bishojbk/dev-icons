...
export class UltralyticsIconElement extends HTMLElement {
...
export function registerUltralyticsIcon(name = 'devicon-ultralytics') {
  if (!customElements.get(name)) {
    customElements.define(name, UltralyticsIconElement);
  }
}
