...
export class InkscapeIconElement extends HTMLElement {
...
export function registerInkscapeIcon(name = 'devicon-inkscape') {
  if (!customElements.get(name)) {
    customElements.define(name, InkscapeIconElement);
  }
}
