...
export class AlacrittyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F46D01';
...
export function registerAlacrittyIcon(name = 'devicon-alacritty') {
  if (!customElements.get(name)) {
    customElements.define(name, AlacrittyIconElement);
  }
}
