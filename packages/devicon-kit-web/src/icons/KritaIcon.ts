...
export class KritaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#3BABFF';
...
export function registerKritaIcon(name = 'devicon-krita') {
  if (!customElements.get(name)) {
    customElements.define(name, KritaIconElement);
  }
}
