...
export class OcamlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#EC6813';
...
export function registerOcamlIcon(name = 'devicon-ocaml') {
  if (!customElements.get(name)) {
    customElements.define(name, OcamlIconElement);
  }
}
