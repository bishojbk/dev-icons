...
export function registerAndroidstudioIcon(name = 'devicon-androidstudio') {
  if (!customElements.get(name)) {
    customElements.define(name, AndroidstudioIconElement);
  }
}
