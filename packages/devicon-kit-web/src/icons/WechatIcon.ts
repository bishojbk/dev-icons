...
export class WechatIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#07C160';
...
export function registerWechatIcon(name = 'devicon-wechat') {
  if (!customElements.get(name)) {
    customElements.define(name, WechatIconElement);
  }
}
