...
export class XcodeIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#147EFB';
...
export function registerXcodeIcon(name = 'devicon-xcode') {
  if (!customElements.get(name)) {
    customElements.define(name, XcodeIconElement);
  }
}
