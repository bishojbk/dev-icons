...
export class NumpyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#013243';
...
export function registerNumpyIcon(name = 'devicon-numpy') {
  if (!customElements.get(name)) {
    customElements.define(name, NumpyIconElement);
  }
}
