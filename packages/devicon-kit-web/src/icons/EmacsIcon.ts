...
export class EmacsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#7F5AB6';
...
export function registerEmacsIcon(name = 'devicon-emacs') {
  if (!customElements.get(name)) {
    customElements.define(name, EmacsIconElement);
  }
}
