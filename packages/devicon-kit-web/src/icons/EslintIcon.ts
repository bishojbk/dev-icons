...
export class EslintIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#4B32C3';
...
export function registerEslintIcon(name = 'devicon-eslint') {
  if (!customElements.get(name)) {
    customElements.define(name, EslintIconElement);
  }
}
