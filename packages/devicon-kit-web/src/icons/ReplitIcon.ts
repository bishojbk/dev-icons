...
export class ReplitIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F26207';
...
export function registerReplitIcon(name = 'devicon-replit') {
  if (!customElements.get(name)) {
    customElements.define(name, ReplitIconElement);
  }
}
