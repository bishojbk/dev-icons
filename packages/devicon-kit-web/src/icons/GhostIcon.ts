...
export class GhostIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#15171A';
...
export function registerGhostIcon(name = 'devicon-ghost') {
  if (!customElements.get(name)) {
    customElements.define(name, GhostIconElement);
  }
}
