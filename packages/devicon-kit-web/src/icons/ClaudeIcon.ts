...
export class ClaudeIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#D97757';
...
export function registerClaudeIcon(name = 'devicon-claude') {
  if (!customElements.get(name)) {
    customElements.define(name, ClaudeIconElement);
  }
}
