...
export class PostgresqlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#4169E1';
...
export function registerPostgresqlIcon(name = 'devicon-postgresql') {
  if (!customElements.get(name)) {
    customElements.define(name, PostgresqlIconElement);
  }
}
