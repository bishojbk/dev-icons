...
export class OpenseaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#2081E2';
...
export function registerOpenseaIcon(name = 'devicon-opensea') {
  if (!customElements.get(name)) {
    customElements.define(name, OpenseaIconElement);
  }
}
