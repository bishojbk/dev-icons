...
export class FirebaseIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#DD2C00';
...
export function registerFirebaseIcon(name = 'devicon-firebase') {
  if (!customElements.get(name)) {
    customElements.define(name, FirebaseIconElement);
  }
}
