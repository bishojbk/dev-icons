...
export class PostmanIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF6C37';
...
export function registerPostmanIcon(name = 'devicon-postman') {
  if (!customElements.get(name)) {
    customElements.define(name, PostmanIconElement);
  }
}
