...
export class ScikitlearnIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F7931E';
...
export function registerScikitlearnIcon(name = 'devicon-scikitlearn') {
  if (!customElements.get(name)) {
    customElements.define(name, ScikitlearnIconElement);
  }
}
