...
export class ApacheairflowIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#017CEE';
...
export function registerApacheairflowIcon(name = 'devicon-apacheairflow') {
  if (!customElements.get(name)) {
    customElements.define(name, ApacheairflowIconElement);
  }
}
