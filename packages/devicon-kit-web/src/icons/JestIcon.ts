...
export class JestIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#C21325';
...
export function registerJestIcon(name = 'devicon-jest') {
  if (!customElements.get(name)) {
    customElements.define(name, JestIconElement);
  }
}
