...
export class FastapiIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#009688';
...
export function registerFastapiIcon(name = 'devicon-fastapi') {
  if (!customElements.get(name)) {
    customElements.define(name, FastapiIconElement);
  }
}
