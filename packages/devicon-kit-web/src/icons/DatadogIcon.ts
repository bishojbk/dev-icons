...
export class DatadogIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#632CA6';
...
export function registerDatadogIcon(name = 'devicon-datadog') {
  if (!customElements.get(name)) {
    customElements.define(name, DatadogIconElement);
  }
}
