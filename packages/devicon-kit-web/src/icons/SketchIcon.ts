...
export class SketchIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F7B500';
...
export function registerSketchIcon(name = 'devicon-sketch') {
  if (!customElements.get(name)) {
    customElements.define(name, SketchIconElement);
  }
}
