...
export class ZigIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F7A41D';
...
export function registerZigIcon(name = 'devicon-zig') {
  if (!customElements.get(name)) {
    customElements.define(name, ZigIconElement);
  }
}
