...
export class BehanceIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1769FF';
...
export function registerBehanceIcon(name = 'devicon-behance') {
  if (!customElements.get(name)) {
    customElements.define(name, BehanceIconElement);
  }
}
