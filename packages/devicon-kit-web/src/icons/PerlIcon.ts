...
export class PerlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#0073A1';
...
export function registerPerlIcon(name = 'devicon-perl') {
  if (!customElements.get(name)) {
    customElements.define(name, PerlIconElement);
  }
}
