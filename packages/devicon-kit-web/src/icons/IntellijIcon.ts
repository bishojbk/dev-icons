...
export class IntellijIconElement extends HTMLElement {
...
export function registerIntellijIcon(name = 'devicon-intellij') {
  if (!customElements.get(name)) {
    customElements.define(name, IntellijIconElement);
  }
}
