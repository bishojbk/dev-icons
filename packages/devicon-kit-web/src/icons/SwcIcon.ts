...
export class SwcIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F8C457';
...
export function registerSwcIcon(name = 'devicon-swc') {
  if (!customElements.get(name)) {
    customElements.define(name, SwcIconElement);
  }
}
