...
export class AssemblyscriptIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#007ACC';
...
export function registerAssemblyscriptIcon(name = 'devicon-assemblyscript') {
  if (!customElements.get(name)) {
    customElements.define(name, AssemblyscriptIconElement);
  }
}
