...
export function registerJekyllIcon(name = 'devicon-jekyll') {
  if (!customElements.get(name)) {
    customElements.define(name, JekyllIconElement);
  }
}
