...
export class ItchioIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FA5C5C';
...
export function registerItchioIcon(name = 'devicon-itchio') {
  if (!customElements.get(name)) {
    customElements.define(name, ItchioIconElement);
  }
}
