...
export function registerIterm2Icon(name = 'devicon-iterm2') {
  if (!customElements.get(name)) {
    customElements.define(name, Iterm2IconElement);
  }
}
