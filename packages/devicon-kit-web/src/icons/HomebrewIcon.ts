...
export class HomebrewIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FBB040';
...
export function registerHomebrewIcon(name = 'devicon-homebrew') {
  if (!customElements.get(name)) {
    customElements.define(name, HomebrewIconElement);
  }
}
