...
export class VitestIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#00FF74';
...
export function registerVitestIcon(name = 'devicon-vitest') {
  if (!customElements.get(name)) {
    customElements.define(name, VitestIconElement);
  }
}
