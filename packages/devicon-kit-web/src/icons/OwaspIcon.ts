...
export function registerOwaspIcon(name = 'devicon-owasp') {
  if (!customElements.get(name)) {
    customElements.define(name, OwaspIconElement);
  }
}
