...
export class PreactIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#673AB8';
...
export function registerPreactIcon(name = 'devicon-preact') {
  if (!customElements.get(name)) {
    customElements.define(name, PreactIconElement);
  }
}
