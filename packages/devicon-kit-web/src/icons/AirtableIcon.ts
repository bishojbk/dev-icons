...
export class AirtableIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#18BFFF';
...
export function registerAirtableIcon(name = 'devicon-airtable') {
  if (!customElements.get(name)) {
    customElements.define(name, AirtableIconElement);
  }
}
