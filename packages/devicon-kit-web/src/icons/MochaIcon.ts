...
export class MochaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#8D6748';
...
export function registerMochaIcon(name = 'devicon-mocha') {
  if (!customElements.get(name)) {
    customElements.define(name, MochaIconElement);
  }
}
