...
export class HaskellIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5D4F85';
...
export function registerHaskellIcon(name = 'devicon-haskell') {
  if (!customElements.get(name)) {
    customElements.define(name, HaskellIconElement);
  }
}
