...
export class DebianIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#A81D33';
...
export function registerDebianIcon(name = 'devicon-debian') {
  if (!customElements.get(name)) {
    customElements.define(name, DebianIconElement);
  }
}
