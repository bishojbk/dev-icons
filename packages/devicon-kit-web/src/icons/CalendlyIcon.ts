...
export class CalendlyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#006BFF';
...
export function registerCalendlyIcon(name = 'devicon-calendly') {
  if (!customElements.get(name)) {
    customElements.define(name, CalendlyIconElement);
  }
}
