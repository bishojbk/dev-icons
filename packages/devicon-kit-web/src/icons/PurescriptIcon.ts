...
export class PurescriptIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#14161A';
...
export function registerPurescriptIcon(name = 'devicon-purescript') {
  if (!customElements.get(name)) {
    customElements.define(name, PurescriptIconElement);
  }
}
