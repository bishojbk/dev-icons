...
export class LangchainIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1C3C3C';
...
export function registerLangchainIcon(name = 'devicon-langchain') {
  if (!customElements.get(name)) {
    customElements.define(name, LangchainIconElement);
  }
}
