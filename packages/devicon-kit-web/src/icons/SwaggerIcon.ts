...
export class SwaggerIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#85EA2D';
...
export function registerSwaggerIcon(name = 'devicon-swagger') {
  if (!customElements.get(name)) {
    customElements.define(name, SwaggerIconElement);
  }
}
