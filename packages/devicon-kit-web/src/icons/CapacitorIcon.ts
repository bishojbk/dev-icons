...
export class CapacitorIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#119EFF';
...
export function registerCapacitorIcon(name = 'devicon-capacitor') {
  if (!customElements.get(name)) {
    customElements.define(name, CapacitorIconElement);
  }
}
