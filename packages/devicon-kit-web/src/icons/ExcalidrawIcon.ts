...
export class ExcalidrawIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#6965DB';
...
export function registerExcalidrawIcon(name = 'devicon-excalidraw') {
  if (!customElements.get(name)) {
    customElements.define(name, ExcalidrawIconElement);
  }
}
