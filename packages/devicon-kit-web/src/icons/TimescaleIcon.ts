...
export class TimescaleIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FDB515';
...
export function registerTimescaleIcon(name = 'devicon-timescale') {
  if (!customElements.get(name)) {
    customElements.define(name, TimescaleIconElement);
  }
}
