...
export class ElmIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1293D8';
...
export function registerElmIcon(name = 'devicon-elm') {
  if (!customElements.get(name)) {
    customElements.define(name, ElmIconElement);
  }
}
