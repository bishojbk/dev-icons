...
export class NomadIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#00CA8E';
...
export function registerNomadIcon(name = 'devicon-nomad') {
  if (!customElements.get(name)) {
    customElements.define(name, NomadIconElement);
  }
}
