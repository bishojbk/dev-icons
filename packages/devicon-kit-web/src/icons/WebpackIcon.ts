...
export class WebpackIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#8DD6F9';
...
export function registerWebpackIcon(name = 'devicon-webpack') {
  if (!customElements.get(name)) {
    customElements.define(name, WebpackIconElement);
  }
}
