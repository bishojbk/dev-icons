...
export class UbuntuIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E95420';
...
export function registerUbuntuIcon(name = 'devicon-ubuntu') {
  if (!customElements.get(name)) {
    customElements.define(name, UbuntuIconElement);
  }
}
