...
export class VimIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#019733';
...
export function registerVimIcon(name = 'devicon-vim') {
  if (!customElements.get(name)) {
    customElements.define(name, VimIconElement);
  }
}
