...
export class SqliteIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#003B57';
...
export function registerSqliteIcon(name = 'devicon-sqlite') {
  if (!customElements.get(name)) {
    customElements.define(name, SqliteIconElement);
  }
}
