...
export class OpenwrtIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#00B5E2';
...
export function registerOpenwrtIcon(name = 'devicon-openwrt') {
  if (!customElements.get(name)) {
    customElements.define(name, OpenwrtIconElement);
  }
}
