...
export class MermaidIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF3670';
...
export function registerMermaidIcon(name = 'devicon-mermaid') {
  if (!customElements.get(name)) {
    customElements.define(name, MermaidIconElement);
  }
}
