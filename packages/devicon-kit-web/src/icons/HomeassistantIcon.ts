...
export class HomeassistantIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#18BCF2';
...
export function registerHomeassistantIcon(name = 'devicon-homeassistant') {
  if (!customElements.get(name)) {
    customElements.define(name, HomeassistantIconElement);
  }
}
