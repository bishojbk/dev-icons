...
export class CaddyIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#1F88C0';
...
export function registerCaddyIcon(name = 'devicon-caddy') {
  if (!customElements.get(name)) {
    customElements.define(name, CaddyIconElement);
  }
}
