...
export class BugcrowdIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F26822';
...
export function registerBugcrowdIcon(name = 'devicon-bugcrowd') {
  if (!customElements.get(name)) {
    customElements.define(name, BugcrowdIconElement);
  }
}
