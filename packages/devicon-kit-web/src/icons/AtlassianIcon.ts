...
export class AtlassianIconElement extends HTMLElement {
...
export function registerAtlassianIcon(name = 'devicon-atlassian') {
  if (!customElements.get(name)) {
    customElements.define(name, AtlassianIconElement);
  }
}
