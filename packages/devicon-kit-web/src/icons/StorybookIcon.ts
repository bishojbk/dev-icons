...
export class StorybookIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FF4785';
...
export function registerStorybookIcon(name = 'devicon-storybook') {
  if (!customElements.get(name)) {
    customElements.define(name, StorybookIconElement);
  }
}
