...
export class TravisciIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#3EAAAF';
...
export function registerTravisciIcon(name = 'devicon-travisci') {
  if (!customElements.get(name)) {
    customElements.define(name, TravisciIconElement);
  }
}
