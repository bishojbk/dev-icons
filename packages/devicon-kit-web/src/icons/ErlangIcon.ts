...
export class ErlangIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#A90533';
...
export function registerErlangIcon(name = 'devicon-erlang') {
  if (!customElements.get(name)) {
    customElements.define(name, ErlangIconElement);
  }
}
