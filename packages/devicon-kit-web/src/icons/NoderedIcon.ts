...
export class NoderedIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#8F0000';
...
export function registerNoderedIcon(name = 'devicon-nodered') {
  if (!customElements.get(name)) {
    customElements.define(name, NoderedIconElement);
  }
}
