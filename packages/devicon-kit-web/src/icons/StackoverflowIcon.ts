...
export class StackoverflowIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#F58025';
...
export function registerStackoverflowIcon(name = 'devicon-stackoverflow') {
  if (!customElements.get(name)) {
    customElements.define(name, StackoverflowIconElement);
  }
}
