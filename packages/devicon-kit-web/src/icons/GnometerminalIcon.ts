...
export class GnometerminalIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#241F31';
...
export function registerGnometerminalIcon(name = 'devicon-gnometerminal') {
  if (!customElements.get(name)) {
    customElements.define(name, GnometerminalIconElement);
  }
}
