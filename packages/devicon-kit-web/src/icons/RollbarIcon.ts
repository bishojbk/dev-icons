...
export class RollbarIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#3569F3';
...
export function registerRollbarIcon(name = 'devicon-rollbar') {
  if (!customElements.get(name)) {
    customElements.define(name, RollbarIconElement);
  }
}
