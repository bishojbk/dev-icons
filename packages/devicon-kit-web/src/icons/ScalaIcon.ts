...
export class ScalaIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#DC322F';
...
export function registerScalaIcon(name = 'devicon-scala') {
  if (!customElements.get(name)) {
    customElements.define(name, ScalaIconElement);
  }
}
