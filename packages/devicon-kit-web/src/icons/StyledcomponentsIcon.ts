...
export class StyledcomponentsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#DB7093';
...
export function registerStyledcomponentsIcon(name = 'devicon-styledcomponents') {
  if (!customElements.get(name)) {
    customElements.define(name, StyledcomponentsIconElement);
  }
}
