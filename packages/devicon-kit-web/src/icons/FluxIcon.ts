...
export class FluxIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5468FF';
...
export function registerFluxIcon(name = 'devicon-flux') {
  if (!customElements.get(name)) {
    customElements.define(name, FluxIconElement);
  }
}
