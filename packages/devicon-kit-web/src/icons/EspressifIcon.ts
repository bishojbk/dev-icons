...
export class EspressifIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E7352C';
...
export function registerEspressifIcon(name = 'devicon-espressif') {
  if (!customElements.get(name)) {
    customElements.define(name, EspressifIconElement);
  }
}
