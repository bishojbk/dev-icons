...
export class MailchimpIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#FFE01B';
...
export function registerMailchimpIcon(name = 'devicon-mailchimp') {
  if (!customElements.get(name)) {
    customElements.define(name, MailchimpIconElement);
  }
}
