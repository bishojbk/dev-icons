...
export class MattermostIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#0058CC';
...
export function registerMattermostIcon(name = 'devicon-mattermost') {
  if (!customElements.get(name)) {
    customElements.define(name, MattermostIconElement);
  }
}
