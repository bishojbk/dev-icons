...
export class RubygemsIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#E9573F';
...
export function registerRubygemsIcon(name = 'devicon-rubygems') {
  if (!customElements.get(name)) {
    customElements.define(name, RubygemsIconElement);
  }
}
