...
export class TomlIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#9C4121';
...
export function registerTomlIcon(name = 'devicon-toml') {
  if (!customElements.get(name)) {
    customElements.define(name, TomlIconElement);
  }
}
