...
export class MlflowIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#0194E2';
...
export function registerMlflowIcon(name = 'devicon-mlflow') {
  if (!customElements.get(name)) {
    customElements.define(name, MlflowIconElement);
  }
}
