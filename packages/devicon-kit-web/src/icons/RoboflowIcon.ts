...
export class RoboflowIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#6706CE';
...
export function registerRoboflowIcon(name = 'devicon-roboflow') {
  if (!customElements.get(name)) {
    customElements.define(name, RoboflowIconElement);
  }
}
