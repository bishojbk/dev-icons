...
export class LinearIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#5E6AD2';
...
export function registerLinearIcon(name = 'devicon-linear') {
  if (!customElements.get(name)) {
    customElements.define(name, LinearIconElement);
  }
}
