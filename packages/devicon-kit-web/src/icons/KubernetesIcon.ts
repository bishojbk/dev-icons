...
export class KubernetesIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#326CE5';
...
export function registerKubernetesIcon(name = 'devicon-kubernetes') {
  if (!customElements.get(name)) {
    customElements.define(name, KubernetesIconElement);
  }
}
