...
export class LetsencryptIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#003A70';
...
export function registerLetsencryptIcon(name = 'devicon-letsencrypt') {
  if (!customElements.get(name)) {
    customElements.define(name, LetsencryptIconElement);
  }
}
