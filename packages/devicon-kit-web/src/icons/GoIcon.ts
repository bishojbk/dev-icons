...
export class GoIconElement extends HTMLElement {
  ...
  private render() {
    ...
    const color = this.getAttribute('color') || '#00ADD8';
...
export function registerGoIcon(name = 'devicon-go') {
  if (!customElements.get(name)) {
    customElements.define(name, GoIconElement);
  }
}
