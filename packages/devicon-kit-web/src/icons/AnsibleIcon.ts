...
export class AnsibleIconElement extends HTMLElement {
...
export function registerAnsibleIcon(name = 'devicon-ansible') {
  if (!customElements.get(name)) {
    customElements.define(name, AnsibleIconElement);
  }
}
