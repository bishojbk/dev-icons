...
export const FirefoxIcon = defineComponent({
  name: 'FirefoxIcon',
  props: {
    size: { type: [Number, String], default: 'md' },
    color: { type: String, default: '#FF7139' },
